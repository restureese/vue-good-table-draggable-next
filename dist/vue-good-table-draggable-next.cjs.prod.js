...
const _hoisted_5$6 = /*#__PURE__*/require$$0.createElementVNode("span", {
  id: "change-page-hint",
  style: {"display":"none"}
...
function _sfc_render$6(_ctx, _cache, $props, $setup, $data, $options) {
  return (require$$0.openBlock(), require$$0.createElementBlock("div", _hoisted_1$6, [
    ($props.infoFn)
      ? (require$$0.openBlock(), require$$0.createElementBlock("div", _hoisted_2$6, require$$0.toDisplayString($props.infoFn($options.infoParams)), 1 /* TEXT */))
      : ($props.mode === 'pages')
        ? (require$$0.openBlock(), require$$0.createElementBlock("form", {
            key: 1,
            onSubmit: _cache[1] || (_cache[1] = require$$0.withModifiers(() => {}, ["prevent"]))
          }, [
            require$$0.createElementVNode("label", {
              for: $data.id,
              class: "page-info__label"
            }, [
              require$$0.createElementVNode("span", null, require$$0.toDisplayString($props.pageText), 1 /* TEXT */),
              require$$0.createElementVNode("input", {
                id: $data.id,
                "aria-describedby": "change-page-hint",
                "aria-controls": "vgb-table",
                class: "footer__navigation__page-info__current-entry",
                type: "text",
                onKeyup: _cache[0] || (_cache[0] = require$$0.withKeys(require$$0.withModifiers((...args) => ($options.changePage && $options.changePage(...args)), ["stop"]), ["enter"])),
                value: $props.currentPage
              }, null, 40 /* PROPS, HYDRATE_EVENTS */, _hoisted_4$6),
              require$$0.createElementVNode("span", null, require$$0.toDisplayString($options.pageInfo), 1 /* TEXT */)
            ], 8 /* PROPS */, _hoisted_3$6),
            _hoisted_5$6
          ], 32 /* HYDRATE_EVENTS */))
        : (require$$0.openBlock(), require$$0.createElementBlock("div", _hoisted_6$6, require$$0.toDisplayString($options.recordInfo), 1 /* TEXT */))
  ]))
}
...
function _sfc_render$5(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_pagination_page_info = require$$0.resolveComponent("pagination-page-info");

  return (require$$0.openBlock(), require$$0.createElementBlock("div", _hoisted_1$5, [
    ($props.perPageDropdownEnabled)
      ? (require$$0.openBlock(), require$$0.createElementBlock("div", _hoisted_2$5, [
          require$$0.createElementVNode("form", null, [
            require$$0.createElementVNode("label", {
              for: $data.id,
              class: "footer__row-count__label"
            }, require$$0.toDisplayString($props.rowsPerPageText) + ":", 9 /* TEXT, PROPS */, _hoisted_3$5),
            require$$0.withDirectives(require$$0.createElementVNode("select", {
              ...
              (require$$0.openBlock(true), require$$0.createElementBlock(require$$0.Fragment, null, require$$0.renderList($data.rowsPerPageOptions, (option, idx) => {
                return (require$$0.openBlock(), require$$0.createElementBlock("option", {
                  key: idx,
                  value: option
                }, require$$0.toDisplayString(option), 9 /* TEXT, PROPS */, _hoisted_5$5))
              }), 128 /* KEYED_FRAGMENT */)),
              ($props.paginateDropdownAllowAll)
                ? (require$$0.openBlock(), require$$0.createElementBlock("option", {
                    key: 0,
                    value: $props.total
                  }, require$$0.toDisplayString($props.allText), 9 /* TEXT, PROPS */, _hoisted_6$5))
                : require$$0.createCommentVNode("v-if", true)
            ], 40 /* PROPS, HYDRATE_EVENTS */, _hoisted_4$5), [
              [require$$0.vModelSelect, $data.currentPerPage]
            ])
          ])
        ]))
      : require$$0.createCommentVNode("v-if", true),
    require$$0.createElementVNode("div", _hoisted_7$5, [
      require$$0.createVNode(_component_pagination_page_info, {
      ...
      require$$0.createElementVNode("button", {
        type: "button",
        "aria-controls": "vgt-table",
        class: require$$0.normalizeClass(["footer__navigation__page-btn", { disabled: !$options.prevIsPossible }]),
        onClick: _cache[2] || (_cache[2] = require$$0.withModifiers((...args) => ($options.previousPage && $options.previousPage(...args)), ["prevent","stop"]))
      }, [
        require$$0.createElementVNode("span", {
          "aria-hidden": "true",
          class: require$$0.normalizeClass(["chevron", { 'left': !$props.rtl, 'right': $props.rtl }])
        }, null, 2 /* CLASS */),
        require$$0.createElementVNode("span", null, require$$0.toDisplayString($props.prevText), 1 /* TEXT */)
      ], 2 /* CLASS */),
      require$$0.createElementVNode("button", {
        type: "button",
        "aria-controls": "vgt-table",
        class: require$$0.normalizeClass(["footer__navigation__page-btn", { disabled: !$options.nextIsPossible }]),
        onClick: _cache[3] || (_cache[3] = require$$0.withModifiers((...args) => ($options.nextPage && $options.nextPage(...args)), ["prevent","stop"]))
      }, [
        require$$0.createElementVNode("span", null, require$$0.toDisplayString($props.nextText), 1 /* TEXT */),
        require$$0.createElementVNode("span", {
          "aria-hidden": "true",
          class: require$$0.normalizeClass(["chevron", { 'right': !$props.rtl, 'left': $props.rtl }])
        }, null, 2 /* CLASS */)
      ], 2 /* CLASS */)
    ])
  ]))
...
const _hoisted_4$4 = /*#__PURE__*/require$$0.createElementVNode("span", {
  "aria-hidden": "true",
  class: "input__icon"
}, [
  /*#__PURE__*/require$$0.createElementVNode("div", { class: "magnifying-glass" })
], -1 /* HOISTED */);
const _hoisted_5$4 = /*#__PURE__*/require$$0.createElementVNode("span", { class: "sr-only" }, "Search", -1 /* HOISTED */);
const _hoisted_6$4 = [
  _hoisted_4$4,
  _hoisted_5$4
];
...
function _sfc_render$4(_ctx, _cache, $props, $setup, $data, $options) {
  return ($options.showControlBar)
    ? (require$$0.openBlock(), require$$0.createElementBlock("div", _hoisted_1$4, [
        require$$0.createElementVNode("div", _hoisted_2$4, [
          ($props.searchEnabled)
            ? (require$$0.openBlock(), require$$0.createElementBlock("form", {
                key: 0,
                onSubmit: _cache[2] || (_cache[2] = require$$0.withModifiers(() => {}, ["prevent"])),
                role: "search"
              }, [
                require$$0.createElementVNode("label", { for: $data.id }, _hoisted_6$4, 8 /* PROPS */, _hoisted_3$4),
                require$$0.createElementVNode("input", {
                  id: $data.id,
                  type: "text",
                  ...
                  onKeyup: _cache[1] || (_cache[1] = require$$0.withKeys($event => ($options.entered($event.target.value)), ["enter"]))
                }, null, 40 /* PROPS, HYDRATE_EVENTS */, _hoisted_7$4)
              ], 32 /* HYDRATE_EVENTS */))
            : require$$0.createCommentVNode("v-if", true)
        ]),
        require$$0.createElementVNode("div", _hoisted_8$3, [
          require$$0.renderSlot(_ctx.$slots, "internal-table-actions")
        ])
      ]))
    : require$$0.createCommentVNode("v-if", true)
}
...
(function webpackUniversalModuleDefinition(root, factory) {
	module.exports = factory(require$$0__default, require$$1);
...
function _sfc_render$3(_ctx, _cache, $props, $setup, $data, $options) {
  return ($options.hasFilterRow)
    ? (require$$0.openBlock(), require$$0.createElementBlock("tr", _hoisted_1$3, [
        ($props.expandRowsEnabled)
          ? (require$$0.openBlock(), require$$0.createElementBlock("th", _hoisted_2$3))
          : require$$0.createCommentVNode("v-if", true),
        ($props.lineNumbers)
          ? (require$$0.openBlock(), require$$0.createElementBlock("th", _hoisted_3$3))
          : require$$0.createCommentVNode("v-if", true),
        ($props.selectable)
          ? (require$$0.openBlock(), require$$0.createElementBlock("th", _hoisted_4$3))
          : require$$0.createCommentVNode("v-if", true),
        (require$$0.openBlock(true), require$$0.createElementBlock(require$$0.Fragment, null, require$$0.renderList($props.columns, (column, index) => {
          return (require$$0.openBlock(), require$$0.createElementBlock(require$$0.Fragment, { key: index }, [
            (!column.hidden)
              ? (require$$0.openBlock(), require$$0.createElementBlock("th", {
                  key: 0,
                  class: require$$0.normalizeClass($options.getClasses(column))
                }, [
                  require$$0.renderSlot(_ctx.$slots, "column-filter", {
                    column: column,
                    updateFilters: $options.updateSlotFilter
                  }, () => [
                    ($options.isFilterable(column))
                      ? (require$$0.openBlock(), require$$0.createElementBlock("div", _hoisted_5$3, [
                          (!$options.isDropdown(column))
                            ? (require$$0.openBlock(), require$$0.createElementBlock("input", {
                                ...
                                onKeyup: require$$0.withKeys($event => ($options.updateFiltersOnEnter(column, $event.target.value)), ["enter"]),
                                onInput: $event => ($options.updateFiltersOnKeyup(column, $event.target.value))
                              }, null, 40 /* PROPS, HYDRATE_EVENTS */, _hoisted_6$3))
                            : require$$0.createCommentVNode("v-if", true),
                          require$$0.createCommentVNode(" options are a list of primitives "),
                          ($options.isDropdownArray(column))
                            ? (require$$0.openBlock(), require$$0.createElementBlock("select", {
                                key: 1,
                                name: $options.getName(column),
                                class: "vgt-select",
                                value: $data.columnFilters[$options.fieldKey(column.field)],
                                ...
                                require$$0.createElementVNode("option", _hoisted_8$2, require$$0.toDisplayString($options.getPlaceholder(column)), 1 /* TEXT */),
                                (require$$0.openBlock(true), require$$0.createElementBlock(require$$0.Fragment, null, require$$0.renderList(column.filterOptions.filterDropdownItems, (option, i) => {
                                  return (require$$0.openBlock(), require$$0.createElementBlock("option", {
                                    key: i,
                                    value: option
                                  }, require$$0.toDisplayString(option), 9 /* TEXT, PROPS */, _hoisted_9$2))
                                }), 128 /* KEYED_FRAGMENT */))
                              ], 40 /* PROPS, HYDRATE_EVENTS */, _hoisted_7$3))
                            : require$$0.createCommentVNode("v-if", true),
                          require$$0.createCommentVNode(" options are a list of objects with text and value "),
                          ($options.isDropdownObjects(column))
                            ? (require$$0.openBlock(), require$$0.createElementBlock("select", {
                                ...
                                require$$0.createElementVNode("option", _hoisted_11$1, require$$0.toDisplayString($options.getPlaceholder(column)), 1 /* TEXT */),
                                (require$$0.openBlock(true), require$$0.createElementBlock(require$$0.Fragment, null, require$$0.renderList(column.filterOptions.filterDropdownItems, (option, i) => {
                                  return (require$$0.openBlock(), require$$0.createElementBlock("option", {
                                    key: i,
                                    value: option.value
                                  }, require$$0.toDisplayString(option.text), 9 /* TEXT, PROPS */, _hoisted_12$1))
                                }), 128 /* KEYED_FRAGMENT */))
...
function _sfc_render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_vgt_filter_row = require$$0.resolveComponent("vgt-filter-row");

  return (require$$0.openBlock(), require$$0.createElementBlock("thead", null, [
    require$$0.createVNode(_component_draggable, {
      ...
      header: require$$0.withCtx(() => [
        ($props.lineNumbers)
          ? (require$$0.openBlock(), require$$0.createElementBlock("th", _hoisted_1$2))
          : require$$0.createCommentVNode("v-if", true),
        ($props.selectable)
          ? (require$$0.openBlock(), require$$0.createElementBlock("th", _hoisted_2$2, [
              require$$0.createElementVNode("input", {
                type: "checkbox",
          ...
          : require$$0.createCommentVNode("v-if", true),
        ($props.expandRowsEnabled)
          ? (require$$0.openBlock(), require$$0.createElementBlock("th", _hoisted_4$2, [
              require$$0.createElementVNode("a", {
                href: "",
                onClick: _cache[1] || (_cache[1] = require$$0.withModifiers((...args) => ($options.toggleExpandRowsAll && $options.toggleExpandRowsAll(...args)), ["prevent"])),
                class: "vgt-wrap__expander"
              }, " (+) ")
            ]))
          : require$$0.createCommentVNode("v-if", true)
      ]),
      item: require$$0.withCtx(({ element, index }) => [
        (!element.hidden)
          ? (require$$0.openBlock(), require$$0.createElementBlock("th", {
              key: 0,
              scope: "col",
              title: element.tooltip,
              class: require$$0.normalizeClass($options.getHeaderClasses(element, index)),
              style: require$$0.normalizeStyle($data.columnStyles[index]),
              "aria-sort": $options.getColumnSortLong(element),
              "aria-controls": `col-${index}`
            }, [
              require$$0.renderSlot(_ctx.$slots, "table-column", { column: element }, () => [
                require$$0.createTextVNode(require$$0.toDisplayString(element.label), 1 /* TEXT */)
              ]),
              ($options.isSortableColumn(element))
                ? (require$$0.openBlock(), require$$0.createElementBlock("button", {
                    ...
                    require$$0.createElementVNode("span", _hoisted_7$2, " Sort table by " + require$$0.toDisplayString(element.label) + " in " + require$$0.toDisplayString($options.getColumnSortLong(element)) + " order ", 1 /* TEXT */)
    ...
    require$$0.createVNode(_component_vgt_filter_row, {
      ref: "filter-row",
      ...
      "column-filter": require$$0.withCtx((slotProps) => [
        require$$0.renderSlot(_ctx.$slots, "column-filter", {
...
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return (require$$0.openBlock(), require$$0.createElementBlock("tr", null, [
    ($props.headerRow.mode === 'span')
      ? (require$$0.openBlock(), require$$0.createElementBlock("th", {
          ...
          ($props.selectAllByGroup)
            ? require$$0.renderSlot(_ctx.$slots, "table-header-group-select", {
                key: 0,
                columns: $props.columns,
                row: $props.headerRow
              }, () => [
          ...
          require$$0.createElementVNode("span", {
            ...
            ($props.collapsable)
              ? (require$$0.openBlock(), require$$0.createElementBlock("span", {
                  key: 0,
                  class: require$$0.normalizeClass(["triangle", { 'expand': $props.headerRow.vgtIsExpanded }])
                }, null, 2 /* CLASS */))
              : require$$0.createCommentVNode("v-if", true),
            require$$0.renderSlot(_ctx.$slots, "table-header-row", { row: $props.headerRow }, () => [
              ($props.headerRow.html)
                ? (require$$0.openBlock(), require$$0.createElementBlock("span", {
                    key: 0,
                    innerHTML: $props.headerRow.label
                  }, null, 8 /* PROPS */, _hoisted_3$1))
                : (require$$0.openBlock(), require$$0.createElementBlock("span", _hoisted_4$1, require$$0.toDisplayString($props.headerRow.label), 1 /* TEXT */))
            ])
          ])
        ], 8 /* PROPS */, _hoisted_1$1))
      : require$$0.createCommentVNode("v-if", true),
    require$$0.createCommentVNode(" if the mode is not span, we display every column "),
    ($props.headerRow.mode !== 'span' && $props.lineNumbers)
      ? (require$$0.openBlock(), require$$0.createElementBlock("th", _hoisted_5$1))
      : require$$0.createCommentVNode("v-if", true),
    ($props.headerRow.mode !== 'span' && $props.selectable)
      ? (require$$0.openBlock(), require$$0.createElementBlock("th", _hoisted_6$1, [
          ($props.selectAllByGroup)
            ? require$$0.renderSlot(_ctx.$slots, "table-header-group-select", {
                key: 0,
                columns: $props.columns,
      ...
      : require$$0.createCommentVNode("v-if", true),
    (require$$0.openBlock(true), require$$0.createElementBlock(require$$0.Fragment, null, require$$0.renderList($props.columns, (column, i) => {
      return (require$$0.openBlock(), require$$0.createElementBlock(require$$0.Fragment, { key: i }, [
        ($props.headerRow.mode !== 'span' && !column.hidden)
          ? (require$$0.openBlock(), require$$0.createElementBlock("th", {
              key: 0,
              class: require$$0.normalizeClass(["vgt-row-header", $props.getClasses(i, 'td')]),
              ...
              ($options.columnCollapsable(i))
                ...
                : require$$0.createCommentVNode("v-if", true),
              require$$0.renderSlot(_ctx.$slots, "table-header-row", {
                row: $props.headerRow,
                column: column,
                formattedRow: $props.formattedRow($props.headerRow, true)
              }, () => [
                (!column.html)
                  ? (require$$0.openBlock(), require$$0.createElementBlock("span", _hoisted_9$1, require$$0.toDisplayString($props.collectFormatted($props.headerRow, column, true)), 1 /* TEXT */))
                  : require$$0.createCommentVNode("v-if", true),
                (column.html)
                  ? (require$$0.openBlock(), require$$0.createElementBlock("span", {
                      key: 1,
...
const _hoisted_2 = /*#__PURE__*/require$$0.createElementVNode("span", { class: "vgt-loading__content" }, " Loading... ", -1 /* HOISTED */);
...
const _hoisted_18 = /*#__PURE__*/require$$0.createElementVNode("div", { class: "vgt-center-align vgt-text-disabled" }, " No data for table ", -1 /* HOISTED */);
const _hoisted_19 = {
  key: 2,
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_vgt_pagination = require$$0.resolveComponent("vgt-pagination");
  const _component_vgt_global_search = require$$0.resolveComponent("vgt-global-search");
  const _component_vgt_table_header = require$$0.resolveComponent("vgt-table-header");
  const _component_vgt_header_row = require$$0.resolveComponent("vgt-header-row");

  return (require$$0.openBlock(), require$$0.createElementBlock("div", {
    class: require$$0.normalizeClass($options.wrapStyleClasses)
  }, [
    ($props.isLoading)
      ? (require$$0.openBlock(), require$$0.createElementBlock("div", _hoisted_1, [
          require$$0.renderSlot(_ctx.$slots, "loadingContent", {}, () => [
            _hoisted_2
          ])
        ]))
      : require$$0.createCommentVNode("v-if", true),
    require$$0.createElementVNode("div", {
      class: require$$0.normalizeClass(["vgt-inner-wrap", { 'is-loading': $props.isLoading }])
    }, [
      (_ctx.paginate && _ctx.paginateOnTop)
        ? require$$0.renderSlot(_ctx.$slots, "pagination-top", {
            key: 0,
            pageChanged: $options.pageChanged,
            perPageChanged: $options.perPageChanged,
            total: $props.totalRows || $options.totalRowCount
          }, () => [
            require$$0.createVNode(_component_vgt_pagination, {
              ref: "paginationTop",
        ...
        : require$$0.createCommentVNode("v-if", true),
      require$$0.createVNode(_component_vgt_global_search, {
      ...
      }, require$$0.createSlots({ _: 2 /* DYNAMIC */ }, [
        (_ctx.$slots['table-actions'])
          ? {
              name: "internal-table-actions",
              fn: require$$0.withCtx(() => [
                require$$0.renderSlot(_ctx.$slots, "table-actions")
              ])
            }
          : undefined
      ...
      ($options.selectedRowCount && !_ctx.disableSelectInfo)
        ? (require$$0.openBlock(), require$$0.createElementBlock("div", {
            key: 1,
            class: require$$0.normalizeClass(["vgt-selection-info-row clearfix", _ctx.selectionInfoClass])
          }, [
            require$$0.createTextVNode(require$$0.toDisplayString($options.selectionInfo) + " ", 1 /* TEXT */),
            require$$0.createElementVNode("a", {
              href: "",
              onClick: _cache[1] || (_cache[1] = require$$0.withModifiers($event => ($options.unselectAllInternal(true)), ["prevent"]))
            }, require$$0.toDisplayString(_ctx.clearSelectionText), 1 /* TEXT */),
            require$$0.createElementVNode("div", _hoisted_3, [
              require$$0.renderSlot(_ctx.$slots, "selected-row-actions")
            ])
          ], 2 /* CLASS */))
        : require$$0.createCommentVNode("v-if", true),
      require$$0.createElementVNode("div", _hoisted_4, [
        ($props.fixedHeader)
          ? (require$$0.openBlock(), require$$0.createElementBlock("table", {
              key: 0,
              id: "vgt-table",
              class: require$$0.normalizeClass($options.tableStyleClasses)
            }, [
              require$$0.createElementVNode("colgroup", null, [
                (require$$0.openBlock(true), require$$0.createElementBlock(require$$0.Fragment, null, require$$0.renderList($props.columns, (column, index) => {
                  return (require$$0.openBlock(), require$$0.createElementBlock("col", {
                    key: index,
                    id: `col-${index}`
                  }, null, 8 /* PROPS */, _hoisted_5))
                }), 128 /* KEYED_FRAGMENT */))
              ]),
              require$$0.createCommentVNode(" Table header "),
              require$$0.createVNode(_component_vgt_table_header, {
                ...
                "table-column": require$$0.withCtx((slotProps) => [
                  require$$0.renderSlot(_ctx.$slots, "table-column", {
                    column: slotProps.column
                  }, () => [
                    require$$0.createElementVNode("span", null, require$$0.toDisplayString(slotProps.column.label), 1 /* TEXT */)
                  ])
                ]),
                "column-filter": require$$0.withCtx((slotProps) => [
                  require$$0.renderSlot(_ctx.$slots, "column-filter", {
      ...
      require$$0.createElementVNode("div", {
        class: require$$0.normalizeClass({ 'vgt-responsive': $props.responsive }),
        style: require$$0.normalizeStyle($options.wrapperStyles)
      }, [
        require$$0.createElementVNode("table", {
          id: "vgt-table",
          ref: "table",
          class: require$$0.normalizeClass($options.tableStyles)
        }, [
          require$$0.createElementVNode("colgroup", null, [
            (require$$0.openBlock(true), require$$0.createElementBlock(require$$0.Fragment, null, require$$0.renderList($props.columns, (column, index) => {
              return (require$$0.openBlock(), require$$0.createElementBlock("col", {
          ...
          require$$0.createCommentVNode(" Table body starts here "),
          (require$$0.openBlock(true), require$$0.createElementBlock(require$$0.Fragment, null, require$$0.renderList($options.paginated, (headerRow, hIndex) => {
            return (require$$0.openBlock(), require$$0.createElementBlock("tbody", { key: hIndex }, [
              require$$0.createCommentVNode(" if group row header is at the top "),
              ($options.groupHeaderOnTop)
                ? (require$$0.openBlock(), require$$0.createBlock(_component_vgt_header_row, {
                    key: 0,
                    ...
                    class: require$$0.normalizeClass($options.getRowStyleClass(headerRow)),
                    ...
                    ($options.hasHeaderRowTemplate)
                      ? {
                          ...
                          fn: require$$0.withCtx((slotProps) => [
                            require$$0.renderSlot(_ctx.$slots, "table-header-row", {
                              column: slotProps.column,
                ...
                : require$$0.createCommentVNode("v-if", true),
              require$$0.createCommentVNode(" normal rows here. we loop over all rows "),
              (require$$0.openBlock(true), require$$0.createElementBlock(require$$0.Fragment, null, require$$0.renderList(headerRow.children, (row, index) => {
                return (require$$0.openBlock(), require$$0.createElementBlock(require$$0.Fragment, null, [
                  ($props.groupOptions.collapsable ? headerRow.vgtIsExpanded : true)
                    ? (require$$0.openBlock(), require$$0.createElementBlock("tr", {
                        key: row.originalIndex,
                        class: require$$0.normalizeClass($options.getRowStyleClass(row)),
                        ...
                        ($props.lineNumbers)
                          ? (require$$0.openBlock(), require$$0.createElementBlock("th", _hoisted_8, require$$0.toDisplayString($options.getCurrentIndex(row.originalIndex)), 1 /* TEXT */))
                          : require$$0.createCommentVNode("v-if", true),
                        (_ctx.selectable)
                          ? (require$$0.openBlock(), require$$0.createElementBlock("th", {
                              key: 1,
                              onClick: require$$0.withModifiers($event => ($options.onCheckboxClicked(row, index, $event)), ["stop"]),
                              class: "vgt-checkbox-col"
                            }, [
                              require$$0.createElementVNode("input", {
                                type: "checkbox",
                        ...
                        (require$$0.openBlock(true), require$$0.createElementBlock(require$$0.Fragment, null, require$$0.renderList($props.columns, (column, i) => {
                          return (require$$0.openBlock(), require$$0.createElementBlock(require$$0.Fragment, null, [
                            (!column.hidden && column.field)
                              ? (require$$0.openBlock(), require$$0.createElementBlock("td", {
                                  key: i,
                                  onClick: $event => ($options.onCellClicked(row, column, index, $event)),
                                  class: require$$0.normalizeClass($options.getClasses(i, 'td', row)),
                                  "data-label": $props.compactMode ? column.label : undefined
                                }, [
                                  require$$0.renderSlot(_ctx.$slots, "table-row", {
                                    row: row,
                                    column: column,
                                    ...
                                    (!column.html)
                                      ? (require$$0.openBlock(), require$$0.createElementBlock("span", _hoisted_12, require$$0.toDisplayString($options.collectFormatted(row, column)), 1 /* TEXT */))
                                      : (require$$0.openBlock(), require$$0.createElementBlock("span", {
                                          key: 1,
                  ...
                  (_ctx.expandedRowIndex === index)
                    ? (require$$0.openBlock(), require$$0.createElementBlock("tr", {
                        class: require$$0.normalizeClass($props.expandedRowDetailClasses),
                        key: row.originalIndex
                      }, [
                        require$$0.createElementVNode("td", { colspan: $options.fullColspan }, [
                          require$$0.renderSlot(_ctx.$slots, "row-details", {
                            row: row,
                            formattedRow: $options.formattedRow(row),
                            index: index
                          })
                  ...
                  (row['expanded'])
                    ? (require$$0.openBlock(), require$$0.createElementBlock("tr", {
                        ...
                        require$$0.createElementVNode("td", { colspan: $options.fullColspan }, require$$0.toDisplayString(row["expandedRow"]), 9 /* TEXT, PROPS */, _hoisted_15)
                      ]))
                    : require$$0.createCommentVNode("v-if", true)
                ], 64 /* STABLE_FRAGMENT */))
              }), 256 /* UNKEYED_FRAGMENT */)),
              require$$0.createCommentVNode(" if group row header is at the bottom "),
          ...
          ($options.showEmptySlot)
            ? (require$$0.openBlock(), require$$0.createElementBlock("tbody", _hoisted_16, [
                require$$0.createElementVNode("tr", null, [
                  require$$0.createElementVNode("td", { colspan: $options.fullColspan }, [
                    require$$0.renderSlot(_ctx.$slots, "emptystate", {}, () => [
                      _hoisted_18
                    ])
                  ], 8 /* PROPS */, _hoisted_17)
                ])
      ...
      ($options.hasFooterSlot)
        ? (require$$0.openBlock(), require$$0.createElementBlock("div", _hoisted_19, [
            require$$0.renderSlot(_ctx.$slots, "table-actions-bottom")
          ]))
        : require$$0.createCommentVNode("v-if", true),
      (_ctx.paginate && _ctx.paginateOnBottom)
        ? require$$0.renderSlot(_ctx.$slots, "pagination-bottom", {
            key: 3,
            pageChanged: $options.pageChanged,
            perPageChanged: $options.perPageChanged,
            total: $props.totalRows || $options.totalRowCount
